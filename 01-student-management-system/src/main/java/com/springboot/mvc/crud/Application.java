package com.springboot.mvc.crud;
...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		/*
		 * Student student1=new Student("Anil","Gadade","anil@gmail.com");
		 * studentRepository.save(student1); Student student2=new
		 * Student("Sam","Curran","sam@gmail.com"); studentRepository.save(student2);
		 */
